...
# fetch https://github.com/prometheus/node_exporter/releases/download/v1.6.1/node_exporter-1.6.1.netbsd-amd64.tar.gz -o node_exporter-1.6.1.netbsd-amd64.tar.gz \
#       && tar -xzvf node_exporter-1.6.1.netbsd-amd64.tar.gz \
#       && mv node_exporter-1.6.1.netbsd-amd64/node_exporter /usr/local/bin/node_exporter
